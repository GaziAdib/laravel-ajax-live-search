...
@section('content')
    ...
    <div class="container">
        ...
        <h1 class="text-center mt-5 mb-2 pd-2">Edit Product</h1>
            ...
            <div class="col-md-6 mt-3 mb-3 pd-2">
                <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-2">
                      ...
                      <input type="text" class="form-control" name="title" value="{{ $product->title }}" id="title" placeholder="Enter Title">
                    </div>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control" name="category" value="{{ $product->category }}" id="category" placeholder="Enter Category">
                    </div>
